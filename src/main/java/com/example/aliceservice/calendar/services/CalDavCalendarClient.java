package com.example.aliceservice.calendar.services;

import com.example.aliceservice.calendar.enteties.CalDavCalendar;
import com.example.aliceservice.calendar.enteties.CalDavEvent;
import com.example.aliceservice.calendar.exceptions.NotFoundCalendarException;
import com.example.aliceservice.calendar.exceptions.SaveEventException;
import com.example.aliceservice.calendar.exceptions.UnauthorizedException;
import com.example.aliceservice.calendar.exceptions.XMLDataException;
import com.example.aliceservice.calendar.modules.Deserializer;
import com.example.aliceservice.calendar.modules.Serializer;
...
public class CalDavCalendarClient {
    ...
    public String saveEvent(CalDavEvent targetEvent) throws UnauthorizedException, NotFoundCalendarException, SaveEventException, ClientProtocolException, IOException{
        ...
        var eventAsString = Serializer.serializeEventToString(targetEvent, this.zoneId, this.username);
